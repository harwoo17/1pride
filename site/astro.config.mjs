...
export default defineConfig({
    ...
    integrations: [starlight({
        ...
        components: {
            ...
            // Inline header search (silver bar, white text, in-place
            // dropdown) replacing Starlight's full-screen modal search.
